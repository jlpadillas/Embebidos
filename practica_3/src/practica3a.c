...
int main(void) {
  ...
  ev3_set_duty_cycle_sp(belt_motor, 250);  // Power to the engine
  ...
  // Action! usleep(SUSPENSION_TIME); while ((ev3_motor_state(belt_motor) &
  // MOTOR_RUNNING))
  ...
  //         !((ev3_motor_state(belt_motor)) & MOTOR_HOLDING))) {
  //   ;
  // }
